        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "Game price"),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "Game description"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Game category Identifier")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameId = table.Column<int>(type: "int", nullable: false, comment: "Order user"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Reveiw date")
                },
                constraints: table =>
                {
